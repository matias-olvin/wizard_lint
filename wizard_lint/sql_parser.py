...
class SQLParser():
    ...
    def _return_re_match_unique_before_and_after_list(self, pattern: str, sql_string: str) -> List[dict]:
        ...
        unique_before_and_after_list = [
            {
                "before": before,
                "after": None
            } for before in unique_table_references_set
        ]
    ...
    def _return_rendered_sql_string(self, rendered_before_and_after_list: List[dict], sql_string: str):
    ...
    def add_jinja_templating_to_sql_string(self, sql_string: str):
        ...
        unique_before_and_after_list = self._return_re_match_unique_before_and_after_list(re_pattern, sql_string)
        ...
        for unique_table_ref in unique_before_and_after_list:
            ...
            after = self._replace_vals_for_keys(reversed_dict=reverse_config_dict, table_ref_string=before)
